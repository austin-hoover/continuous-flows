...
parser.add_argument(
    "--nt_val", type=int, default=8, help="number of time steps for validation"
)
...
parser.add_argument(
    "--drop_freq", type=int, default=100, help="how often to decrease learning rate"
)
...
if __name__ == "__main__":
    ...
    log_msg = "{:5s}  {:6s}   {:9s}  {:9s}  {:9s}  {:9s}      {:9s}  {:9s}  {:9s}  {:9s}  ".format(
        "iter",
        " time",
        "loss",
        "L (L_2)",
    ...
    for itr in range(1, args.niters + 1):
        ...
        log_message = "{:05d}  {:6.3f}   {:9.3e}  {:9.3e}  {:9.3e}  {:9.3e}  ".format(
