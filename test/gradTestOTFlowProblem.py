...
g = torch.autograd.grad(
    fx, net.parameters(), retain_graph=True, create_graph=True, allow_unused=True
)

nn.utils.convert_parameters.vector_to_parameters(
    v, netV.parameters()
)  # structure v into the tensors
gv = 0.0
...
# g = torch.autograd.grad(fx,net.w.weight, retain_graph=True, create_graph=True, allow_unused=True)
g = torch.autograd.grad(
    fx, net.N.layers[0].weight, retain_graph=True, create_graph=True, allow_unused=True
)[0]
